    ...
    <div style={{flex:'0 0 210px'}}>
      <ResponsiveContainer width="100%" height={230}>
        <PieChart>
          ...
          <text x="50%" y="46%" textAnchor="middle" style={{fontSize:19,fontWeight:800,fill:C.ink}}>{((data[idx].pago/tot)*100).toFixed(0)}%</text>
...
function MapaCoropletico({ dados, irParaMunicipio }) {
  ...
  const W=600, H=470; // largura menor para cortar vazio lateral, altura para caber tudo
  ...
  return <div style={{background:C.panel,border:`1px solid ${C.line}`,padding:'14px 18px',position:'relative',boxSizing:'border-box'}}>
    ...
    <div style={{position:'relative',width:'100%',maxWidth:W,margin:'0 auto'}}>
      <ComposableMap projection="geoMercator"
        projectionConfig={{ center:[-43.9,-23.05], scale:4700 }}
      ...
      <div style={{position:'absolute',right:6,bottom:6,background:'rgba(255,255,255,0.92)',border:`1px solid ${C.line}`,padding:'7px 9px',width:140}}>
        <div style={{fontSize:10,fontWeight:700,color:C.ink,marginBottom:4}}>Renda petrolífera paga</div>
        <div style={{height:8,background:'linear-gradient(90deg,#BFD9C8,#0F3D2E)',marginBottom:3}}/>
